...
from rvc.nn import attentions, commons, modules
...
class _SynthesizerTrnMsBase_nono(nn.Module):
    def __init__(
        self,
        spec_channels,
        segment_size,
        ...
        **kwargs
        ...
        super(_SynthesizerTrnMsBase_nono, self).__init__()
        self.spec_channels = spec_channels
        self.inter_channels = inter_channels
        self.hidden_channels = hidden_channels
        self.filter_channels = filter_channels
...
class SynthesizerTrnMsNSFsid_nono(_SynthesizerTrnMsBase_nono):
    def __init__(
        self,
        spec_channels,
        segment_size,

...
class MainWindow(QMainWindow):
    ...
    def _build_settings_tab(self):
        ...
        self.th_sl = _sl(-60,0,1,-60); self.th_lbl = QLabel("-60"); self.th_lbl.setMinimumWidth(35)
        ...
        self.bl_sl = _sl(2,150,1,25); self.bl_lbl = QLabel("0.25"); self.bl_lbl.setMinimumWidth(35)
        self.bl_sl.valueChanged.connect(lambda v: self.bl_lbl.setText(f"{v/100:.2f}"))
        add_sl("采样长度", self.bl_sl, self.bl_lbl, r); r+=1
        self.cf_sl = _sl(1,15,1,5); self.cf_lbl = QLabel("0.05"); self.cf_lbl.setMinimumWidth(35)
        self.cf_sl.valueChanged.connect(lambda v: self.cf_lbl.setText(f"{v/100:.2f}"))
        add_sl("淡入淡出", self.cf_sl, self.cf_lbl, r); r+=1
        self.ex_sl = _sl(5,500,1,250); self.ex_lbl = QLabel("2.50"); self.ex_lbl.setMinimumWidth(35)
